...
//                     //show prices:
//                     $("#shop").append('<div style="display: inline"><a target="_blank" href="' + resp.results[i].url + '">' + '<img class="pullImg" style="padding-top:' + imgPadding + ';padding-left:' + imgPadding + ';padding-right' + imgPadding + '" alt="' + resp.results[i].description + '" src="' + resp.results[i].MainImage.url_570xN + '"></img></a><center>$' + resp.results[i].price.slice(0, -3) + '</div>');
//
//                 }
//             // }
//
